...
void QMcCad_VGParamDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QMcCad_VGParamDialog *_t = static_cast<QMcCad_VGParamDialog *>(_o);
        switch (_id) {
        case 0: _t->CanContinue(); break;
        case 1: _t->IsAccepted(); break;
        case 2: _t->SlotMMStateChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->SlotCMStateChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData QMcCad_VGParamDialog::staticMetaObjectExtraData = {
...
const QMetaObject QMcCad_VGParamDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QMcCad_VGParamDialog,
      qt_meta_data_QMcCad_VGParamDialog, &staticMetaObjectExtraData }
};
